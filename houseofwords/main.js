...
var face = "face means something that each person has. It is diferent and unique to each person with many variations and details."; /*Between the quotation marks, 
...
var red = "a color on color palet"; //repeat the instructions with the word "red" (keep in the form of a noun)

var brain = "a human organ"; //repeat the instructions for the word "brain"

var masculine = "adjective describing someone strong"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

var think = "something that come to human mind"; //define 'think' in VERB form,
...
var createScene = function () {
    ...
    var masterWall = buildFromPlan(walls3, ply, height, { interiorUV: new BABYLON.Vector4(0.2, 0, 1, 1), exteriorUV: new BABYLON.Vector4(0.2, 0, 1, 1), interior: true }, scene, madlibs[0]);
    ...
    smallWall2 = buildFromPlan(walls5, ply, height, { interiorUV: new BABYLON.Vector4(0.2, 0, 1, 1), exteriorUV: new BABYLON.Vector4(0.2, 0, 1, 1), interior: true }, scene, madlibs[0]);
