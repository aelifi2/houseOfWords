...
function textTure(text, texture, fontSize, cWidth, cHeight, color, flip = true, bg = "#f0ead6") {
    ...
    for (var i = 0; i < nLines; i++) {
        ...
        if (i == 0) {
            texture.drawText(thisLine, 410, 50 + i * fontSize * 1.5, font, color, bg)
        } else {
...
function buildMat(text, fontSize, cWidth, cHeight, name, scene, color = "black", flip, bg = "#f0ead6") {
